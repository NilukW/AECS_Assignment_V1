...
namespace DexAddressServiceApi.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class WalletsController : ControllerBase
    {
        private readonly DexAddressServiceApiContext _context;

        public WalletsController(DexAddressServiceApiContext context)
        {
            _context = context;
        }
